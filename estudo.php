...
<div class="container mt-5">
    <div class="row">
                                ...
                                <table width="600" cellspacing="0" cellpadding="0" border="0" align="center">
                                    <tbody>
                                        <tr>
                                            <td width="40"></td>
                                            <td width="520">
                                                <font style="font-family: Arial, Helvetica, sans-serif, Verdana, Geneva; font-size: 18px; color: #4a4a4a; line-height: 1.5; text-decoration: none;"><b>Em 2019 bolsa de valores registra o maior valor negociado da história em valores nominais</b></font><br><br>
                                                <font style="font-family: Arial, Helvetica, sans-serif, Verdana, Geneva; font-size: 13px; color: #4a4a4a; line-height: 1.69; text-decoration: none; ">Em 2019 bolsa de valores registra o maior valor negociado da história em valores nominais, ajustados pela inflação e em dólares. ADR´s perdem espaço.</font> <br><br></td>
                                            <td width="40"></td>
                                        </tr>
                                    </tbody>
                                </table>
        ...
        <div class="col-5">
            <form id="teste1">
            <button id="teste1button" type="submit">aaaaaa</button>
...
<script src="./assets/js/teste.js?50000000"></script>
</body>
