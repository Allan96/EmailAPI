         ...
         <div class="row">
            <div class="col-8">
               <div bgcolor="#FBFBFB" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" id="email">
                  <head>
                     <title>
                        Economatica’s platform optimizes your academic papers
                     </title>
                              ...
                              <tbody>
                                 <tr>
                                    <td align="center" height="50" border="0" style="font-family: Arial, Helvetica, sans-serif, Verdana, Geneva; font-size: 14px; color: #ffffff; line-height: 1.5; text-decoration: none;">
                                       ...
                                       <font valign="" style=" vertical-align: super; font-family: Arial, Helvetica, sans-serif; color: #3A3A3A; font-size: 14px; line-height: 1.30">&nbsp; &nbsp; The fantastic insights of the Economatica platform.
                                       </font>
                                    </td>
                                 </tr>
                              </tbody>
                                    ...
                                    <td>
                                       ...
                                       <table width="600" cellspacing="0" cellpadding="0" border="0" align="center">
                                          <tbody>
                                             <tr>
                                                <td width="350">
                                                   <img width="350" src="http://clientes.martinluz.com.br/economatica/emkt/value-reports-img/logo_full.jpg" alt="economatica" style="display:block; border:none; padding:none; margin:none;">
                                                </td>
                                                <td width="40" height="80">
                                                </td>
                                                <td width="29" height="50">
                                                   <a href="http://valuereports.economatica.com/" target="_blank">
                                                   <img width="29" height="29" src="http://clientes.martinluz.com.br/economatica/emkt/value-reports-img/link.png" alt="economatica" style="display:block; border:none; padding:none; margin:none;">
                                                   </a>
                                                </td>
                                                <td width="29" height="50">
                                                   <a href="https://www.linkedin.com/company/25077461/" target="_blank">
                                                   <img width="29" height="29" src="http://clientes.martinluz.com.br/economatica/emkt/value-reports-img/linkedin.jpg" alt="economatica" style="display:block; border:none; padding:none; margin:none;">
                                                   </a>
                                                </td>
                                             </tr>
                                          </tbody>
                                          ...
                                          <tbody>
                                             <tr>
                                                <td width="700" height="70">
                                                   <img width="698" height="225" src="http://clientes.martinluz.com.br/economatica/emkt/value-reports-img/footer.png" alt="" style="display:block; border:none; padding:none; margin:none;">
                                                </td>
                                             </tr>
                                          </tbody>
                                       </table>
